...
class Implementation(Base):
	...
	def initProperties(self):
		super(Implementation, self).initProperties()
		...
		self.DataStructure = (
				("id", "I", True, "implementation", "id"),
				("partid", "I", False, "implementation", "partid"),
				("manufacturerid", "I", False, "implementation", "manufacturerid"),
				("comments", "C", False, "implementation", "comments"),
		)
	...
	def afterInit(self):
		super(Implementation, self).afterInit()
