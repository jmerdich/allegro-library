...
class Footprint(Base):
	...
	def initProperties(self):
		super(Footprint, self).initProperties()
		self.Caption = "Footprint"
		self.DataSource = "footprint"
		self.KeyField = "id"
		...
		self.DataStructure = (
				("id", "I", True, "footprint", "id"),
				("footprintid", "I", False, "footprint", "footprintid"),
				("padsid", "I", False, "footprint", "padsid"),
				("comments", "C", False, "footprint", "comments"),
		)
	...
	def afterInit(self):
		super(Footprint, self).afterInit()
