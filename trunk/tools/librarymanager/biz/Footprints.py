...
class Footprints(Base):
	...
	def initProperties(self):
		super(Footprints, self).initProperties()
		self.Caption = "Footprints"
		self.DataSource = "footprints"
		self.KeyField = "id"
		...
		self.DataStructure = (
				("id", "I", True, "footprints", "id"),
				("name", "C", False, "footprints", "name"),
				("shorthand", "C", False, "footprints", "shorthand"),
				("verificationstatus", "I", False, "footprints", "verificationstatus"),
				("comments", "C", False, "footprints", "comments"),
		)
	...
	def afterInit(self):
		super(Footprints, self).afterInit()
