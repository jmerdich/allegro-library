...
class Manufacturers(Base):
	...
	def initProperties(self):
		super(Manufacturers, self).initProperties()
		self.Caption = "Manufacturers"
		self.DataSource = "manufacturers"
		self.KeyField = "id"
		...
		self.DataStructure = (
				("id", "I", True, "manufacturers", "id"),
				("name", "C", False, "manufacturers", "name"),
				("comments", "C", False, "manufacturers", "comments"),
		)
	...
	def afterInit(self):
		super(Manufacturers, self).afterInit()
