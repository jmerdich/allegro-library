...
class Pad(Base):
	...
	def initProperties(self):
		...
		self.DataStructure = (
				("id", "I", True, "pad", "id"),
				("padid", "I", False, "pad", "padid"),
				("flashid", "I", False, "pad", "flashid"),
				("shapeid", "I", False, "pad", "shapeid"),
				("comments", "C", False, "pad", "comments"),
		)
