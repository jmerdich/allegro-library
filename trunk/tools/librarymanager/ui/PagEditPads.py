...
class PagEditPads(PagEditBase):
	...
	def createItems(self):
		...
		objectRef = dabo.ui.dTextBox(self, NameBase="name",
				DataSource="pads", DataField="name",
		...
		## Field pads.smd
		label = dabo.ui.dLabel(self, NameBase="lblsmd", 
					Caption=biz.getColCaption("smd"))
		objectRef = dabo.ui.dTextBox(self, NameBase="smd",
				DataSource="pads", DataField="smd",
				ToolTipText=biz.getColToolTip("smd"),
				HelpText=biz.getColHelpText("smd")
)
		...
		objectRef = dabo.ui.dTextBox(self, NameBase="comments",
				DataSource="pads", DataField="comments",
		...
		super(PagEditPads, self).createItems()
...
if __name__ == "__main__":
	...
	frm = TestForm(Caption="Test Of PagEditPads", Testing=True)
	test = PagEditPads(frm)
	test.createItems()
