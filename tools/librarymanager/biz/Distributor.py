...
class Distributor(Base):
	...
	def initProperties(self):
		super(Distributor, self).initProperties()
		self.Caption = "Distributor"
		self.DataSource = "distributor"
		self.KeyField = "id"
		...
		self.DataStructure = (
				("id", "I", True, "distributor", "id"),
				("name", "C", False, "distributor", "name"),
				("comments", "C", False, "distributor", "comments"),
		)
	...
	def afterInit(self):
		super(Distributor, self).afterInit()
