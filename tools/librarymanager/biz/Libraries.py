...
class Libraries(Base):
	...
	def initProperties(self):
		super(Libraries, self).initProperties()
		self.Caption = "Libraries"
		self.DataSource = "libraries"
		self.KeyField = "id"
		...
		self.DataStructure = (
				("id", "I", True, "libraries", "id"),
				("name", "C", False, "libraries", "name"),
				("path", "C", False, "libraries", "path"),
				("comments", "C", False, "libraries", "comments"),
		)
	...
	def afterInit(self):
		super(Libraries, self).afterInit()
