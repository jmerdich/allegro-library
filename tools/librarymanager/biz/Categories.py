...
class Categories(Base):
	...
	def initProperties(self):
		super(Categories, self).initProperties()
		...
		self.DataStructure = (
				("id", "I", True, "categories", "id"),
				("name", "C", False, "categories", "name"),
				("master", "I", False, "categories", "master"),
				("comments", "C", False, "categories", "comments"),
		)
	...
	def afterInit(self):
		super(Categories, self).afterInit()
